...
Vagrant.configure("2") do |config|
  config.vm.define "web_1" do |web_1|
      ...
      web_1.vm.synced_folder "D:/ClasesUnivalle/SO/vagrant/vagrantfile2webservers/www1/", "/var/www/html/"
  end
  config.vm.define "web_2" do |web_2|
      ...
      web_2.vm.synced_folder "D:/ClasesUnivalle/SO/vagrant/vagrantfile2webservers/www2/", "/var/www/html/"
  end
end
